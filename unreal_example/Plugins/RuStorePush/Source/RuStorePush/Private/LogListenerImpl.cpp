...
extern "C"
{
    JNIEXPORT void JNICALL Java_ru_rustore_unitysdk_pushclient_wrappers_LogListenerWrapper_NativeLog(JNIEnv* env, jobject, jlong pointer, jstring logString)
    {
        auto castobj = reinterpret_cast<LogListenerImpl*>(pointer);
        castobj->OnLog(JavaTypeConverter::Convert(env, logString));
    }

    JNIEXPORT void JNICALL Java_ru_rustore_unitysdk_pushclient_wrappers_LogListenerWrapper_NativeLogWarning(JNIEnv* env, jobject, jlong pointer, jstring logString)
    {
        auto castobj = reinterpret_cast<LogListenerImpl*>(pointer);
        castobj->OnLogWarning(JavaTypeConverter::Convert(env, logString));
    }

    JNIEXPORT void JNICALL Java_ru_rustore_unitysdk_pushclient_wrappers_LogListenerWrapper_NativeLogError(JNIEnv* env, jobject, jlong pointer, jstring logString)
    {
        auto castobj = reinterpret_cast<LogListenerImpl*>(pointer);
        castobj->OnLogError(JavaTypeConverter::Convert(env, logString));
    }

    JNIEXPORT void JNICALL Java_ru_rustore_unitysdk_pushclient_wrappers_LogListenerWrapper_NativeLogException(JNIEnv*, jobject, jlong pointer, jthrowable throwable)
    {
